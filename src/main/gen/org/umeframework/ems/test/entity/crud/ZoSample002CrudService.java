...
/*
 * EM数据类型测试表2.0:ZO_SAMPLE_002 CRUD service interface declare.<br>
 *
...
public interface ZoSample002CrudService {
     ...
     */
    List<ZoSample002Dto> findList(ZoSample002Dto condition);
     ...
     * @return - matched entity instance list
     */
    List<ZoSample002Dto> findListLike(Map<String, String> condition);
     ...
     * @return - matched entity instance list
     */
    List<ZoSample002Dto> findListMatch(Map<String, String> dynaCondition);
